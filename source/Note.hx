				...
				default:
						...
						switch(noteType)
						{
							case 2:
							{
								...
								animation.addByPrefix('greenScroll', 'green fire0');
								animation.addByPrefix('redScroll', 'red fire0');
								animation.addByPrefix('blueScroll', 'blue fire0');
								animation.addByPrefix('purpleScroll', 'purple fire0');
